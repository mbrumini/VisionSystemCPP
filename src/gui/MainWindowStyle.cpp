...
void MainWindow::applyApplicationStyle()
{
  setStyleSheet(
    ...
    "QCheckBox::indicator:hover{border-color:#4d9cff;background:#202d38;}"
    "QCheckBox::indicator:checked{background:#2f80ed;border:2px solid #f5f7fa;image:none;}"
    "QCheckBox::indicator:checked:disabled{background:#49637d;border-color:#6f7d8a;}"
    "QCheckBox::indicator:unchecked:disabled{background:#151c23;border-color:#3b4652;}"
    "QRadioButton{spacing:8px;color:#eef2f6;}"
    "QRadioButton::indicator{width:18px;height:18px;border:1px solid #6f7d8a;border-radius:9px;background:#19222b;}"
    "QRadioButton::indicator:hover{border-color:#4d9cff;background:#202d38;}"
    "QRadioButton::indicator:checked{background:#2f80ed;border:2px solid #f5f7fa;image:none;}"
    "QRadioButton::indicator:checked:disabled{background:#49637d;border-color:#6f7d8a;}"
    "QRadioButton::indicator:unchecked:disabled{background:#151c23;border-color:#3b4652;}"
    ...
    "QComboBox#geometryChoice{background:#1d2a35;border:1px solid #4b6072;border-radius:6px;padding:7px 10px;color:#f5f7fa;font-weight:600;}"
    "QComboBox#geometryChoice:hover{background:#263746;border-color:#4d9cff;}"
    "QComboBox#geometryChoice::drop-down{width:30px;border-left:1px solid #4b6072;}"
    "QComboBox#geometryChoice QAbstractItemView{background:#1d2a35;color:#f5f7fa;border:1px solid #4d9cff;selection-background-color:#244a78;selection-color:#ffffff;outline:0;}"
